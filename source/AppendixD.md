...
The scope of this user guide is to give an indication of how things work without explaining every line of the code. The main body of the program has already been presented in Appendix A section 6. Here the subroutines get a similar treatment, in the order they currently appear in the source code. 
