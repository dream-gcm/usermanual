...
$$
   \begin{equation*}
      \overline{\cal F} = \overline{{\bf v}.\nabla q} + \overline{{\cal D}(q)}	 \qquad\qquad (B2) 
   \end{equation*}
$$
...
$$
   \begin{equation*}
      \frac{\partial q}{\partial t} + {\bf v}.\nabla q + {\cal D}(q)= \overline{{\cal F}}		\qquad\qquad (B3) 
   \end{equation*}
$$
...
$$
   \begin{equation*}
      \overline{\cal F} = \overline{\bf v}.\nabla \overline{q} + \overline{{\bf v}'.\nabla q'} + {{\cal D}(\overline{q})}	 \qquad\qquad (B4) 
   \end{equation*}
$$
...
$$
   \begin{equation*}
      \frac{d {\bf \Phi}}{dt} + ({\cal A} + {\cal D}){\bf \Phi} = {\cal F}(t)		 \qquad\qquad (B5) 
   \end{equation*}
$$
...
$$
   \begin{equation*}
     \frac{d {\bf \Phi}'}{dt} + ({\cal A} + {\cal D})(\overline{\bf \Phi} + {\bf \Phi}') = \overline{\cal F} + {\cal F}'		\qquad\qquad (B6)
   \end{equation*}
$$
...
$$
   \begin{equation*}
      ({\cal A} + {\cal D})\overline{\bf \Phi} + \overline{O({\bf \Phi}'^2)} = \overline{\cal F}	 \qquad\qquad (B7)
   \end{equation*}
$$
...
$$
   \begin{equation*}
      \frac{d {\bf \Phi}'}{dt} + {\cal L}\Phi' + \left[O({\bf \Phi}'^2) - \overline{O({\bf \Phi}'^2)} \right] = {\cal F}'		 \qquad\qquad (B8)
   \end{equation*}
$$
...
$$
   \begin{equation*}
      \frac{d {\bf \Psi}}{dt} + ({\cal A} + {\cal D}){\bf \Psi} = {\cal G}_{cm}		 \qquad\qquad (B9). 
   \end{equation*}
$$
...
$$
   \begin{equation*}
      {\cal G}_{cm} = \frac{1}{n}  \sum_{i=1}^n ({\cal A} + {\cal D}){\bf \Phi}_i	 \qquad\qquad. 
   \end{equation*}
$$
...
$$
   \begin{equation*}
      \overline{({\cal A} + {\cal D}){\bf \Psi}} = \overline{({\cal A} + {\cal D}){\bf \Phi}}	 \qquad\qquad. 
   \end{equation*}
$$
...
$$
   \begin{equation*}
      ({\cal A} + {\cal D})\overline{\bf \Psi} + \overline{O({\bf \Psi}'^2)} = ({\cal A} + {\cal D})\overline{\bf \Phi} + \overline{O({\bf \Phi}'^2)}		 \qquad\qquad 
   \end{equation*}
$$
...
$$
   \begin{equation*}
    \frac{d {\bf \Psi}_1}{dt} + {\cal L}{\bf \Psi}_1 = 0		 \qquad\qquad (B10)
   \end{equation*}
$$
